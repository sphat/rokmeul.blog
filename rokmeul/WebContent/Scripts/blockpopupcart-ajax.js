	...
	add : function(idProduct, idCombination, addedFromProductPage, callerElement, quantity, whishlist) {
		...
		success: function(jsonData) {
			...
			if (whishlist && !jsonData.errors) 
				...
				ajaxCart.updateCart(jsonData);
			if (!jsonData.errors) {
				$('#blockpopupcart_popup_content').load(baseDir+'modules/blockpopupcart/blockpopupcart-popup.php?content_only .cart_last_product', function(){
					$('#blockpopupcart_loader_container').addClass('hidden');
					$('#blockpopupcartbuttons').click();
				});
			}
			if (jsonData.errors) {
				$('#blockpopupcart_loader_container').addClass('hidden');
